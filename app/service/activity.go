...
type ActivityService interface {
	Create(ctx *gin.Context, input entity.Activity) (res entity.Activity, statusCode int, err error)
	GetAll(ctx *gin.Context) (result []entity.Activity, statusCode int, err error)
	GetByID(ctx *gin.Context, ID uint64) (result entity.Activity, statusCode int, err error)
	UpdateByID(ctx *gin.Context, ID uint64, input entity.Activity) (result entity.Activity, statusCode int, err error)
...
func (srv *activitySrv) Create(ctx *gin.Context, input entity.Activity) (res entity.Activity, statusCode int, err error) {
...
func (srv *activitySrv) GetAll(ctx *gin.Context) (result []entity.Activity, statusCode int, err error) {
...
func (srv *activitySrv) GetByID(ctx *gin.Context, ID uint64) (result entity.Activity, statusCode int, err error) {
...
func (srv *activitySrv) UpdateByID(ctx *gin.Context, ID uint64, input entity.Activity) (result entity.Activity, statusCode int, err error) {
...
func (srv *activitySrv) DeleteByID(ctx *gin.Context, ID uint64) (statusCode int, err error) {
	sm, err := srv.ActivityRepository.GetByID(ctx, ID)
	if errors.Is(err, gorm.ErrRecordNotFound) || sm.ID == 0 {
